...
class Vote(models.Model):
    content_type    = models.ForeignKey(ContentType, related_name="votes", on_delete=models.deletion.CASCADE)
    object_id       = models.PositiveIntegerField()
    key             = models.CharField(max_length=32)
    score           = models.IntegerField()
    user            = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, related_name="votes", on_delete=models.deletion.CASCADE)
...
class SimilarUser(models.Model):
    from_user       = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="similar_users", on_delete=models.deletion.CASCADE)
    to_user         = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="similar_users_from", on_delete=models.deletion.CASCADE)
