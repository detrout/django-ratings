    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(related_name='similar_users', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.CASCADE)),
                ('to_user', models.ForeignKey(related_name='similar_users_from', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Vote',
            fields=[
                ...
                ('content_type', models.ForeignKey(related_name='votes', to='contenttypes.ContentType', on_delete=models.deletion.CASCADE)),
                ('user', models.ForeignKey(related_name='votes', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.CASCADE)),
            ],
        ),
