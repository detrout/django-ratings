...
from .models import RatingTestModel
...
class RatingTestCase(unittest.TestCase):
    def testRatings(self):
        ...
        # Test adding votes
        instance.rating.add(score=1, user=AnonymousUser, ip_address='127.0.0.1')
        self.assertEquals(instance.rating.score, 1)
        self.assertEquals(instance.rating.votes, 1)

        # Test adding votes
        instance.rating.add(score=2, user=AnonymousUser, ip_address='127.0.0.2')
        self.assertEquals(instance.rating.score, 3)
        self.assertEquals(instance.rating.votes, 2)

        # Test changing of votes
        instance.rating.add(score=2, user=AnonymousUser, ip_address='127.0.0.1')
